...
namespace Google.Maps.Examples
{
    ...
    /// <see cref="RoadLatticeCharacterController"/> and <see cref="AIBehaviour"/>
    /// </summary>
    ...
    public class Pathfinding : MonoBehaviour
    {
        ...
        /// </summary>
        public int NumberOfOpponents = 1000;
        ...
        /// </summary>
        public float MaxAIStartDistanceFromAvatar = 2000;
        ...
        /// </summary>
        private List<AIBehaviour> NPCs = new List<AIBehaviour>();
        ...
        private void OnMapLoaded(MapLoadedArgs args)
        {
            if (CharactersContainer != null && BaseMapLoader != null)
            {
                ...
                for (int i = 0; i < NumberOfOpponents; i++)
                {
                    ...
                    AIBehaviour aic = npcGO.GetComponent<AIBehaviour>();
        ...
        public void ActiveAllNPCs(bool isOn)
        {
            ...
            foreach (AIBehaviour aic in NPCs)
